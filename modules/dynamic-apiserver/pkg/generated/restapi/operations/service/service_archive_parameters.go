...
// ServiceArchiveParams contains all the bound params for the service archive operation
...
func (o *ServiceArchiveParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceArchiveParams) validateServiceID(formats strfmt.Registry) error {
