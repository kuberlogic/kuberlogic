...
// NewBackupConfigDeleteParams creates a new BackupConfigDeleteParams object
// no default values defined in spec.
func NewBackupConfigDeleteParams() BackupConfigDeleteParams {

	return BackupConfigDeleteParams{}
}

// BackupConfigDeleteParams contains all the bound params for the backup config delete operation
...
func (o *BackupConfigDeleteParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
