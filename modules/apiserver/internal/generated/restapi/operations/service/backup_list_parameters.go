...
// BackupListParams contains all the bound params for the backup list operation
...
func (o *BackupListParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *BackupListParams) validateServiceID(formats strfmt.Registry) error {
