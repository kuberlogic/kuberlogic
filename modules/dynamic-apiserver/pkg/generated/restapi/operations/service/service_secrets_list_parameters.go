...
// ServiceSecretsListParams contains all the bound params for the service secrets list operation
...
func (o *ServiceSecretsListParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceSecretsListParams) validateServiceID(formats strfmt.Registry) error {
