...
func TestBackupDeleteInvalidValidation(t *testing.T) {
	...
	cmd.SetOut(b)
	cmd.SetArgs([]string{"backup", "delete"})
	err = cmd.Execute()
...
func TestBackupDeleteNotFound(t *testing.T) {
	// make own http client
	expected := "kuberlogic backup not found: test"
...
func TestBackupDeleteSuccessFormatJson(t *testing.T) {
	// make own http client
...
func TestBackupDeleteSuccessFormatYaml(t *testing.T) {
	// make own http client
	expected := map[string]interface{}{}
	client := makeTestClient(200, expected)
	cmd, err := MakeRootCmd(client)
...
func TestBackupDeleteSuccessFormatStr(t *testing.T) {
	// make own http client
	expected := map[string]interface{}{}
	client := makeTestClient(200, expected)
	cmd, err := MakeRootCmd(client)
	...
	expectedResult := fmt.Sprintf("Backup '%s' successfully deleted", id)
