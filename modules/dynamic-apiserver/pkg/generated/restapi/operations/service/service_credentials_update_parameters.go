...
// ServiceCredentialsUpdateParams contains all the bound params for the service credentials update operation
...
func (o *ServiceCredentialsUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceCredentials
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			res = append(res, errors.NewParseError("serviceCredentials", "body", "", err))
		} else {
...
func (o *ServiceCredentialsUpdateParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceCredentialsUpdateParams) validateServiceID(formats strfmt.Registry) error {
