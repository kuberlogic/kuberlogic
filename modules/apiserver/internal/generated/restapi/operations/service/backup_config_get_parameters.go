...
// NewBackupConfigGetParams creates a new BackupConfigGetParams object
// no default values defined in spec.
func NewBackupConfigGetParams() BackupConfigGetParams {

	return BackupConfigGetParams{}
}

// BackupConfigGetParams contains all the bound params for the backup config get operation
...
func (o *BackupConfigGetParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *BackupConfigGetParams) validateServiceID(formats strfmt.Registry) error {
