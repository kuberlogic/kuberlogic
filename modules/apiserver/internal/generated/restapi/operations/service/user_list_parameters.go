...
func (o *UserListParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UserListParams) validateServiceID(formats strfmt.Registry) error {
