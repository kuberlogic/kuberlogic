...
// NewRestoreDeleteParamsWithTimeout creates a new RestoreDeleteParams object
...
// NewRestoreDeleteParamsWithContext creates a new RestoreDeleteParams object
...
// NewRestoreDeleteParamsWithHTTPClient creates a new RestoreDeleteParams object
...
func (o *RestoreDeleteParams) WithContext(ctx context.Context) *RestoreDeleteParams {
	o.SetContext(ctx)
	return o
}
...
func (o *RestoreDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param RestoreID
	if err := r.SetPathParam("RestoreID", o.RestoreID); err != nil {
		return err
	}
