...
// ServiceUnarchiveParams contains all the bound params for the service unarchive operation
...
func (o *ServiceUnarchiveParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceUnarchiveParams) validateServiceID(formats strfmt.Registry) error {
