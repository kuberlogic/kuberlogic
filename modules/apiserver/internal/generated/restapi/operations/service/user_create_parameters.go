...
func (o *UserCreateParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UserCreateParams) validateServiceID(formats strfmt.Registry) error {
